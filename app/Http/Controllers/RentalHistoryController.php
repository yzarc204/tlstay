...
class RentalHistoryController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $bookingData = [
            ...
            'month_unit_price' => $booking->month_unit_price ? (float) $booking->month_unit_price : null,
            'week_unit_price' => $booking->week_unit_price ? (float) $booking->week_unit_price : null,
            'day_unit_price' => $booking->day_unit_price ? (float) $booking->day_unit_price : null,
