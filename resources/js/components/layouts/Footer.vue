  ...
  <footer class="bg-primary-900 text-white">
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div class="lg:col-span-1">
          <div class="flex items-center space-x-2 mb-4">
            <div class="w-10 h-10 bg-primary rounded-lg flex items-center justify-center">
              <span class="text-white font-bold text-xl">RT</span>
            </div>
            <span class="text-xl font-bold">{{ siteName }}</span>
          </div>
          <p v-if="siteAddress" class="text-primary-200 text-sm mb-4 leading-relaxed">
            {{ siteAddress }}
          </p>
          <p v-else class="text-primary-200 text-sm mb-4 leading-relaxed">
            Nền tảng cho thuê phòng trọ hàng đầu Việt Nam. Tìm kiếm và đặt phòng trọ dễ dàng, nhanh chóng.
          </p>
          
          <!-- Contact Info -->
          <div v-if="contactPhone || contactEmail" class="mb-4 space-y-2">
            <p v-if="contactPhone" class="text-primary-200 text-sm flex items-center">
              <PhoneIcon class="w-4 h-4 mr-2" />
              <a :href="`tel:${contactPhone}`" class="hover:text-secondary transition-colors">
                {{ contactPhone }}
              </a>
            </p>
            <p v-if="contactEmail" class="text-primary-200 text-sm flex items-center">
              <EnvelopeIcon class="w-4 h-4 mr-2" />
              <a :href="`mailto:${contactEmail}`" class="hover:text-secondary transition-colors">
                {{ contactEmail }}
              </a>
            </p>
          </div>
        ...
        <!-- Quick Links -->
        <div>
          <h3 class="text-base font-semibold mb-4 text-white">Liên kết nhanh</h3>
          <ul class="space-y-3 text-primary-200">
            ...
            <li>
              <a href="#" class="hover:text-secondary transition-colors text-sm">Blog</a>
            </li>
          </ul>
        </div>
        ...
        <!-- Services -->
        <div>
          <h3 class="text-base font-semibold mb-4 text-white">Dịch vụ</h3>
          <ul class="space-y-3 text-primary-200">
            <li>
              <a href="#" class="hover:text-secondary transition-colors text-sm">Cho thuê phòng</a>
            </li>
            <li>
              <a href="#" class="hover:text-secondary transition-colors text-sm">Hỗ trợ khách hàng</a>
            </li>
            <li>
              <a href="#" class="hover:text-secondary transition-colors text-sm">Phương thức thanh toán</a>
            </li>
            <li>
              <a href="#" class="hover:text-secondary transition-colors text-sm">Câu hỏi thường gặp</a>
            </li>
            <li>
              <a href="#" class="hover:text-secondary transition-colors text-sm">Trung tâm trợ giúp</a>
            </li>
          </ul>
        </div>
        ...
        <!-- Newsletter -->
        <div>
          <h3 class="text-base font-semibold mb-4 text-white">Bản tin</h3>
      ...
      <div class="border-t border-primary-800 pt-8">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p class="text-primary-200 text-sm text-center md:text-left">
