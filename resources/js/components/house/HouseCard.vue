  ...
  <div class="card group cursor-pointer" @click="goToDetail">
    ...
    <div class="relative overflow-hidden h-56">
      ...
      <div class="absolute top-4 left-4">
        <span class="badge bg-primary text-white"> {{ house.availableRooms }} phòng trống </span>
      </div>
      <div class="absolute top-4 right-4">
        <button
          class="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300 shadow-md hover:shadow-lg"
        >
...
import { HeartIcon, MapPinIcon, BuildingOfficeIcon, HomeIcon, StarIcon } from '@heroicons/vue/24/outline'
