      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 class="text-4xl font-bold mb-6 text-secondary">
            Hơn 1000 căn phòng trọ có sẵn để thuê tại các
            thành phố lớn trên toàn quốc
          </h2>
          <p class="text-gray-600 mb-6 leading-relaxed">
            TL STAY là nền tảng tìm kiếm phòng trọ lớn nhất
            tại Việt Nam và là điểm khởi đầu lý tưởng cho
            hành trình tìm kiếm phòng trọ của bạn. Bạn có
            thể dễ dàng tìm kiếm và quản lý những căn phòng
            yêu thích.
          </p>
        ...
        <div class="relative">
          ...
          <!-- Map Overlay -->
          <div
            class="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl"
          >
